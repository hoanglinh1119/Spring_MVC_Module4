...
public class SmartphoneController {
  @Autowired
    private SmartphoneSevice smartphoneSevice;
    ...
    public Smartphone createSmartphone(@RequestBody Smartphone smartphone) {
        return smartphoneSevice.save(smartphone);
    }

    @RequestMapping(value = "", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public Iterable<Smartphone> allPhones() {
        return smartphoneSevice.findAll();
    }
    ...
    public Smartphone deleteSmartphone(@PathVariable Integer id) {
        return smartphoneSevice.delete(id);
    }

    @RequestMapping(value = "/edit/{id}", method = RequestMethod.GET)
    public ModelAndView editSmartphonePage(@PathVariable Integer id){
        Smartphone smartphone = smartphoneSevice.findById(id);
        if(smartphone != null) {
